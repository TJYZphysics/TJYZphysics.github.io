...
const BUILDER_PALETTES = {
  ...
  light: {
    background: '#f4f5f8',
    grid: 'rgba(23,26,34,0.14)',
    road: '#e2e6ef',
    roadBorder: 'rgba(122,132,152,0.5)',
    route: 'rgba(108,120,140,0.65)',
    entranceWash: 'rgba(40,114,85,0.18)',
    entranceFill: 'rgba(40,114,85,0.34)',
    entranceMarker: 'rgba(40,114,85,0.45)',
    entranceLine: '#287255',
    coreWash: 'rgba(152,100,22,0.16)',
    coreFill: 'rgba(152,100,22,0.3)',
    coreMarker: 'rgba(152,100,22,0.42)',
    coreLine: '#986416',
    hole: '#eef1f6',
    holeBorder: 'rgba(122,132,152,0.55)',
  },
} as const
